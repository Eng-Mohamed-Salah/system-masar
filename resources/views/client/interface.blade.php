            ...
            <div id="myDIV" class="boxSection">
                ...
                <button class="buttonHeader tablink btnCards" onclick="openPage('Followe', this)">
                    <div class="d-flex mb-3">
                        ...
                        <h5 class="d-inline-block mx-3">Customers</h5>
                    </div>
                    <ul class="timeline">
                        <li " class="dotsTop"><i class="fa-solid fa-circle"></i> Clients</li>
                        <li "><i class="fa-solid fa-circle"></i>Plans</li>
                        <li " class="dotsBottom"><i class="fa-solid fa-circle"></i>History</li>
                    </ul>
                </button>
                <!-- Card System Company -->
                <button class="buttonHeader default tablink btnCards active" onclick="openPage('System', this)" id="defaultOpen">
                    ...
                    <ul class="timeline">
                        ...
                        <li class="dotsBottom"><i class="fa-solid fa-circle"></i>Employee</li>
                    </ul>
                </button>
                <!-- Card Service -->
                <button class="buttonHeader tablink btnCards" onclick="openPage('Service', this)">
                    <div class="d-flex mb-3">
                        ...
                        <h5 class="d-inline-block mx-3">Services</h5>
                    </div>
                    <ul class="timeline">
                        <li class="dotsTop"><i class="fa-solid fa-circle"></i> Marketing</li>
                        <li><i class="fa-solid fa-circle"></i>Programing</li>
                        <li><i class="fa-solid fa-circle"></i>Videos</li>
                        <li class="dotsBottom"><i class="fa-solid fa-circle"></i>Gallery </li>
                    </ul>
                </button>
            </div>
            <div class="detailsCards">
                <div id="Followe" class="tabcontent">
                    ...
                    <div class="boxBtnSection">
                        <a href="{{ (Auth::user()->role != 'hr' && Auth::user()->role != 'admin' && Auth::user()->role != 'dataentry') ? '#' : url('/show-client') }}" class="btnSection {{ (Auth::user()->role != 'hr' && Auth::user()->role != 'admin' && Auth::user()->role != 'dataentry') ? 'cursor-no-drop' : "" }}">
                            <p>Clients</p>
                        </a>
                        <a href="{{ (Auth::user()->role != 'hr' && Auth::user()->role != 'admin' && Auth::user()->role != 'dataentry') ? '#' : url('/show-plane') }}" class="btnSection {{ (Auth::user()->role != 'hr' && Auth::user()->role != 'admin' && Auth::user()->role != 'dataentry') ? 'cursor-no-drop' : "" }}">
                            <p>Plans</p>
                        </a>
                        <a href="{{ (Auth::user()->role != 'hr' && Auth::user()->role != 'admin' && Auth::user()->role != 'dataentry') ? '#' : url('/show-history') }}" class="btnSection {{ (Auth::user()->role != 'hr' && Auth::user()->role != 'admin' && Auth::user()->role != 'dataentry') ? 'cursor-no-drop' : "" }}">
                            <p>History</p>
                        </a>
                    </div>
                </div>
                ...
                <div id="Service" class="tabcontent">
                    ...
                    <div class="boxBtnSection">
                        {{-- @can('isAdmin') --}}
                        <a href="{{ (Auth::user()->role != 'hr' && Auth::user()->role != 'admin' && Auth::user()->role != 'dataentry') ? '#' : url('/show-marketing') }}" class="btnSection {{ (Auth::user()->role != 'hr' && Auth::user()->role != 'admin' && Auth::user()->role != 'dataentry') ? 'cursor-no-drop' : "" }}">
                            {{-- <img class="iconImg" src="{{asset($globalVariable .'assetsClinet')}}/imgs/content.png" alt=""> --}}
                            <p>Marketing</p>
                        </a>

                        {{-- @endcan --}}
                        <a href="{{ (Auth::user()->role != 'hr' && Auth::user()->role != 'admin' && Auth::user()->role != 'dataentry') ? '#' : url('/show-programming') }}" class="btnSection {{ (Auth::user()->role != 'hr' && Auth::user()->role != 'admin' && Auth::user()->role != 'dataentry') ? 'cursor-no-drop' : "" }}">
                            {{-- <img class="iconImg" src="{{asset($globalVariable .'assetsClinet')}}/imgs/coding.png" alt=""> --}}
                            <p>Programing</p>
                        </a>
                        <a href="{{ (Auth::user()->role != 'hr' && Auth::user()->role != 'admin' && Auth::user()->role != 'dataentry') ? '#' : url('/show-video') }}" class="btnSection {{ (Auth::user()->role != 'hr' && Auth::user()->role != 'admin' && Auth::user()->role != 'dataentry') ? 'cursor-no-drop' : "" }}">
                            {{-- <img class="iconImg" src="{{asset($globalVariable .'assetsClinet')}}/imgs/add.png" alt=""> --}}
                            <p> Videos</p>
                        </a>
                        <a href="{{ (Auth::user()->role != 'hr' && Auth::user()->role != 'admin' && Auth::user()->role != 'dataentry') ? '#' : url('/show-galary') }}" class="btnSection {{ (Auth::user()->role != 'hr' && Auth::user()->role != 'admin' && Auth::user()->role != 'dataentry') ? 'cursor-no-drop' : "" }}">
                            {{-- <img class="iconImg" src="{{asset($globalVariable .'assetsClinet')}}/imgs/add.png" alt=""> --}}
                            <p> Gallery</p>
                        </a>
                    </div>

...
@section('content')
    ...
    <header>
        ...
        <div class="titleSection">
            <h3>Edit Employee</h3>
            <div class="d-flex">
                <form class="mx-2" action="{{ route('admin.hr.edit',$employee->id) }}" method="GET">
                    <div class="filterdate">
                        <select class=" py-2" id="month" name="month">
                        ...
                        <button type="submit" class="btnGray py-2">Filter</button>
                    </div>
                </form>
